...
export type GaryeongMsgSendRecommendResponse = object;
...
export interface GaryeongQueryGetReportByIdResponse {
 ...
 */
export interface GaryeongQueryParamsResponse {
    /** params holds all the parameters of this module. */
    params?: GaryeongParams;
}

export interface GaryeongReport {
    /** @format uint64 */
    id?: string;
    creator?: string;
    target?: string;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     *
     * @tags Query
     * @name QueryGetReportById
     * @summary Queries a list of GetReportById items.
     * @request GET:/garyeong/garyeong/get_report_by_id/{id}
     */
     ...
     * @request GET:/garyeong/garyeong/params
     */
